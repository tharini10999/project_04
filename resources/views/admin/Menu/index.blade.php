...
<div class="container-xxl flex-grow-1 container-p-y">
    <div class="card">
        <h5 class="card-header">เมนูต้นไม้</h5>
          ...
          <table class="table mt-4">
            ...
            <tbody class="table-border-bottom-0">
              ...
              <tr>
                            ...
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body d-flex justify-content-center">
                                        <img src="{{ asset('Menu').'/'.$item->image }}" class="img-thumbnail" alt="#" />
                                    </div>
                    ...
                    <td>
                        <a href="{{route('Menu.edit',$item->id)}}"><i class='bx bxs-edit'>Edit</i></a>
                        <a href="{{route('Menu.delete',$item->id)}}"><i class='bx bx-trash'>Delete</i></a>
                    </td>
