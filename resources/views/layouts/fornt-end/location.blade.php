                    ...
                    <div class="container">
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="blog-item">
                                    <div class="blog-img">
                                        <a href="#"><img src="{{ asset('fornt-end/upload/8_n.jpg')}}" alt=""></a>
                            ...
                            <div class="col-md-4">
                                <div class="blog-item">
                                    <div class="blog-img">
                                        <a href="#"><img src="{{ asset('fornt-end/upload/9_n.jpg')}}" alt=""></a>
                            ...
                            <div class="col-md-4">
                                <div class="blog-item">
                                    <div class="blog-img">
                                        <a href="#"><img src="{{ asset('fornt-end/upload/2_n.jpg')}}" alt=""></a>
